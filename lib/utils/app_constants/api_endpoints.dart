abstract final class ApiEndpoints {
  ...
  // Two-factor / email verification challenges
  ...
  /// `PATCH` to update an existing channel (handle, displayName, categorySlugs).
  ...
  // Analytics. The /auth variant needs a browser CSRF token; the optional-auth
  // route attributes off the same Bearer token without one.
