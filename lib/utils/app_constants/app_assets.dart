abstract final class AppAssets {
  ...
  /// GospelTube broadcast mark (orange glyph, no container).
  static const gtubeLogo = '$_images/gtube_logo.png';

  /// Dark silk texture behind the onboarding screens.
  static const onboardingBg = '$_images/onboarding_bg.png';

  // Social provider marks.
  static const iconGoogle = '$_icons/google.svg';
  ...
  /// Filled mail glyph for the verify-email badge; [iconMail] is the outlined one.
  static const iconMailBadge = '$_icons/mail_badge.svg';

  /// Worship-crowd plate behind the discovery-source screen.
  static const worshipBg = '$_images/worship_bg.png';

  // Discovery-source ("how did you find us") glyphs.
  static const iconRadioButton = '$_icons/radio_button.svg';
  static const iconSourceFriend = '$_icons/src_friend.svg';
  static const iconSourceChurch = '$_icons/src_church.svg';
  static const iconSourceSocial = '$_icons/src_social.svg';
  static const iconSourceYoutube = '$_icons/src_youtube.svg';
  static const iconSourceSearch = '$_icons/src_search.svg';
  static const iconSourcePodcast = '$_icons/src_podcast.svg';

  // Creator profile setup glyphs.
  static const iconCheckCircle = '$_icons/check_circle.svg';
  static const iconCheckSmallGreen = '$_icons/check_small_green.svg';

  // Interest-category chip glyphs.
  ...
  static const iconCatFamilyC = '$_icons/cat_family_c.svg';

  static const iconCheckbox = '$_icons/checkbox.svg';

  // Payment provider glyphs.
  ...
  // Creator-type fork glyphs.
  static const iconPerson = '$_icons/person.svg';
  static const iconOrganization = '$_icons/organization.svg';

  // Role-selection option glyphs.
  static const iconPlayOutline = '$_icons/play_outline.svg';
  static const iconVideoCamera = '$_icons/video_camera.svg';

  // Welcome feature-card glyphs.
  static const iconPlay = '$_icons/play.svg';
  static const iconCast = '$_icons/cast.svg';
  static const iconBookOpen = '$_icons/book_open.svg';
  static const iconHeadphones = '$_icons/headphones.svg';

  // Home feed card glyphs. Each has preserveAspectRatio="none", so render at the
  // natural size listed beside it inside the design's icon box.
  static const iconFeedHeart = '$_icons/feed_heart.svg'; // 14.667 x 13.334
  static const iconFeedBookmark =
      '$_icons/feed_bookmark.svg'; // 12.667 x 14.663
  static const iconFeedChat = '$_icons/feed_chat.svg'; // 13.333 x 13.333
  static const iconFeedUsers = '$_icons/feed_users.svg'; // 12.926 x 12
  static const iconFeedMore = '$_icons/feed_more.svg'; // 15.833 x 2.5
  static const iconFeedVerified = '$_icons/feed_verified.svg'; // 12.83 x 13.311
  static const iconFeedLoudspeaker =
      '$_icons/feed_loudspeaker.svg'; // 9 x 9.286
  static const iconFeedPlusCircle = '$_icons/feed_plus_circle.svg'; // 12 x 12
  static const iconNavHome = '$_icons/nav_home.svg'; // 16.463 x 15.881
  static const iconNavExplore = '$_icons/nav_explore.svg'; // 18.333 x 18.333
  static const iconNavFollowing = '$_icons/nav_following.svg'; // 17.917 x 17.5
  static const iconFeedLiveDot = '$_icons/feed_live_dot.svg'; // 7 x 7
}
